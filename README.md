...
This repository contains labels and annotations for all images and the PyTorch implementation of the following paper: [How to Correctly Detect Face-Masks for COVID-19 from Visual Information?](https://www.mdpi.com/2076-3417/11/5/2070/htm){:target="_blank" rel="noopener"} [1]
